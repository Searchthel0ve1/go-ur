...
func (b *SimulatedBackend) Rollback() {
	blocks, _ := core.GenerateChain(nil, b.blockchain, b.blockchain.CurrentBlock(), b.database, 1, func(int, *core.BlockGen) {})
...
func (b *SimulatedBackend) SendTransaction(tx *types.Transaction) error {
	blocks, _ := core.GenerateChain(nil, b.blockchain, b.blockchain.CurrentBlock(), b.database, 1, func(number int, block *core.BlockGen) {
